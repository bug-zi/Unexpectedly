...
export function FavoritesPage() {
  ...
  const handleSkip = () => {
    ...
    const currentIndex = filteredFavorites.findIndex(
      f => f.questionId === filteredFavorites[0]?.questionId
    );
    const nextIndex = (currentIndex + 1) % filteredFavorites.length;
    if (filteredFavorites[nextIndex]) {
      handleQuestionClick(filteredFavorites[nextIndex].questionId);
    }
  };
