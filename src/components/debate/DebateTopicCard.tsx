...
export function DebateTopicCard({ topic, isGenerating, onGenerate, onSelectStance, disabled }: DebateTopicCardProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      ...
      >
        {/* 辩题展示区域 */}
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-2 border-amber-200 dark:border-amber-700 rounded-3xl p-8 text-center mb-6">
          {isGenerating ? (
