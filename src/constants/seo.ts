...
export const seoConfig: Record<string, PageSEO> = {
  ...
  '/knowledge-popularize': {
    title: '万万没想到 - 知识科普，心理学/哲学/科学趣味知识',
    description:
      '从心理学效应到认知偏差，从哲学思辨到科学冷知识。用轻松有趣的方式，拓展你的知识边界。',
    keywords: ['知识科普', '心理学效应', '认知偏差', '哲学思辨', '科学冷知识'],
  },
  '/knowledge-popularize/world-records': {
    title: '万万没想到 - 世界之最，探索极限与奇迹',
    description:
      '发现世界上最快、最远、最大、最小的极限记录。在惊叹中拓展认知边界，激发好奇心。',
    keywords: ['世界之最', '世界纪录', '极限记录', '趣味知识'],
  },
  '/knowledge-popularize/systems-thinking': {
    title: '万万没想到 - 系统思维，学会看透事物之间的联系',
    description:
      '从蝴蝶效应到马太效应，掌握系统思维的核心概念。学会看到隐藏在表象之下的规律和联系。',
    keywords: ['系统思维', '蝴蝶效应', '马太效应', '思维模型'],
  },
  '/knowledge-popularize/health-management': {
    title: '万万没想到 - 健康管理，用科学方法管理身心健康',
    description:
      '睡眠、运动、饮食、心理健康——用科学方法和思维工具管理你的身心健康，建立可持续的生活习惯。',
    keywords: ['健康管理', '睡眠科学', '运动健康', '心理健康', '生活习惯'],
  },
  '/logic-reasoning': {
